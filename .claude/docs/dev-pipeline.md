...
Źródło: compound-engineering-plugin (zaadaptowane do stacku Laravel 12 + Inertia 2 + Vue 3 + TypeScript + Tailwind + Filament + PostgreSQL, kontenery Docker php-fpm+nginx)
